...
export default function PregnancyWeek4() {
  ...
  return (
    <BlogLayout
      ...
      description="Week 4 marks implantation, the first signs of pregnancy, and the possibility of a positive test. Learn about your baby’s development and early symptoms."
      sections={sections}
