  ...
  return (
    <SessionProvider session={session}>
      ...
      <Head>
        ...
        <meta
          name="description"
          content="Explore Belly Buds parenting (motherhood) blogs, pregnancy week-wise guides, and parenting tips. Learn from experts and real experiences to make your motherhood (Parenting) journey smoother."
        />
